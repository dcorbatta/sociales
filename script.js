        ...
        questions: [
            {
                ...
                correct: 0,
                explanation: "¡Correcto! Madrid es la capital de España. Es una ciudad muy grande y bonita."
            },
            {
                question: "¿En qué continente está África?",
                visual: "🌍",
                answers: ["Asia", "Europa", "África", "América"],
                correct: 2,
                explanation: "¡Muy bien! África es un continente, no está EN otro continente."
            },
            {
                ...
                correct: 1,
                explanation: "¡Excelente! El río Nilo en África es el más largo del mundo."
            },
            {
                question: "¿Qué país tiene forma de bota?",
                visual: "👢",
                answers: ["Francia", "España", "Italia", "Grecia"],
                correct: 2,
                explanation: "¡Perfecto! Italia tiene forma de bota. ¿Ya lo habías notado en el mapa?"
            },
            {
                ...
                correct: 3,
                explanation: "¡Increíble! El océano Pacífico es enorme, ¡cubre un tercio del planeta!"
            }
        ]
    },
    history: {
        ...
        questions: [
            {
                question: "¿Quién construyó las pirámides?",
                visual: "🔺",
                answers: ["Romanos", "Griegos", "Egipcios", "Mayas"],
                correct: 2,
                explanation: "¡Correcto! Los antiguos egipcios construyeron las pirámides hace miles de años."
            },
            {
                question: "¿En qué año llegó Cristóbal Colón a América?",
                visual: "⛵",
                answers: ["1491", "1492", "1493", "1500"],
                correct: 1,
                explanation: "¡Excelente! En 1492 llegó Colón a América. ¡Qué aventura tan grande!"
            },
            {
                question: "¿Cómo se llamaban los guerreros japoneses antiguos?",
                visual: "⚔️",
                answers: ["Ninjas", "Samurái", "Shogun", "Ronin"],
                correct: 1,
                explanation: "¡Muy bien! Los samurái eran guerreros honorables del antiguo Japón."
            },
            {
                question: "¿Qué civilización inventó la escritura?",
                visual: "📜",
                answers: ["Egipcios", "Sumerios", "Chinos", "Griegos"],
                correct: 1,
                explanation: "¡Genial! Los sumerios inventaron la primera forma de escritura."
            },
            {
                question: "¿En qué siglo vivimos ahora?",
                visual: "📅",
                answers: ["Siglo XX", "Siglo XXI", "Siglo XIX", "Siglo XXII"],
                correct: 1,
                explanation: "¡Correcto! Estamos en el siglo XXI. ¡El siglo de la tecnología!"
            }
        ]
    },
    culture: {
        name: "Detective Cultural",
        icon: "🎭",
        questions: [
            {
                question: "¿De qué país es tradicional el tango?",
                visual: "💃",
                answers: ["Brasil", "Argentina", "México", "Colombia"],
                correct: 1,
                explanation: "¡Perfecto! El tango es un baile muy elegante de Argentina."
            },
            {
                question: "¿Qué comida es típica de Italia?",
                visual: "🍝",
                answers: ["Sushi", "Tacos", "Pizza", "Hamburguesas"],
                correct: 2,
                explanation: "¡Muy bien! La pizza es de Italia, aunque ahora se come en todo el mundo."
            },
            {
                question: "¿En qué país se inventó el papel?",
                visual: "📄",
                answers: ["Japón", "China", "India", "Egipto"],
                correct: 1,
                explanation: "¡Excelente! Los chinos inventaron el papel hace más de 2000 años."
            },
            {
                ...
                correct: 2,
                explanation: "¡Correcto! El chino mandarín lo hablan más de mil millones de personas."
            },
            {
                question: "¿Qué instrumento es típico de Escocia?",
                visual: "🎵",
                answers: ["Guitarra", "Piano", "Gaita", "Violín"],
                correct: 2,
                explanation: "¡Genial! La gaita es el instrumento tradicional de Escocia."
            }
        ]
    },
    puzzle: {
        name: "Rompecabezas Rápido",
        icon: "🧩",
        questions: [
            {
                ...
                answers: ["5", "6", "7", "8"],
                correct: 2,
                explanation: "¡Correcto! Hay 7 continentes: Asia, África, América del Norte, América del Sur, Europa, Oceanía y Antártida."
            },
            {
                question: "¿Cuál de estas banderas es de México?",
                visual: "🏴",
                answers: ["🇪🇸 Roja y amarilla", "🇲🇽 Verde, blanca y roja", "🇧🇷 Verde y amarilla", "🇦🇷 Azul y blanca"],
                correct: 1,
                explanation: "¡Muy bien! La bandera de México es verde, blanca y roja con un águila en el centro."
            },
            {
                question: "¿Qué forma tiene la Tierra?",
                visual: "🌍",
                answers: ["Cuadrada", "Plana", "Redonda", "Triangular"],
                correct: 2,
                explanation: "¡Excelente! La Tierra es redonda como una pelota gigante."
            },
            {
                question: "¿Cuántos días tiene un año?",
                visual: "📅",
                answers: ["360", "365", "370", "400"],
                correct: 1,
                explanation: "¡Perfecto! Un año tiene 365 días, y 366 en años bisiestos."
            },
            {
                question: "¿Cuál es el animal nacional de Australia?",
                visual: "🦘",
                answers: ["Koala", "Canguro", "Ornitorrinco", "Dingo"],
                correct: 1,
                explanation: "¡Genial! El canguro está en el escudo de Australia. ¡Qué animal tan especial!"
            }
        ]
    }
};
